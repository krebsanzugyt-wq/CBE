...
export const styles = StyleSheet.create({
  ...
  tabBar: { position: "absolute", left: 6, right: 6, flexDirection: "row", backgroundColor: "rgba(255,255,255,0.9)", borderRadius: 24, borderWidth: 1, borderColor: "rgba(0,0,0,0.08)", minHeight: 64, paddingVertical: 10, paddingHorizontal: 4, shadowColor: "#000", shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 6 } },
  tabBtn: { minHeight: 48, borderRadius: 14, alignItems: "center", justifyContent: "center", marginHorizontal: 1, paddingHorizontal: 2 },
  tabBtnInactive: { flex: 1 },
  tabBtnActive: { flex: 1.8, backgroundColor: "rgba(0,0,0,0.06)", paddingHorizontal: 6 },
  tabText: { color: "#5C5C66", fontWeight: "700", fontSize: 11 },
